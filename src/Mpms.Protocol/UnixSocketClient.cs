...
public class MpdUnixSocketClient : IMpdClient
{
    ...
    public MpdUnixSocketClient(MpdUnixSocketParameters parameters)
    {
    ...
    public MpdUnixSocketParameters Parameters { get; }
    ...
    {
        var endPoint = new UnixDomainSocketEndPoint(Parameters.Path);

        _socket.SendTimeout = Parameters.Timeout;
        _socket.ReceiveTimeout = Parameters.Timeout;
